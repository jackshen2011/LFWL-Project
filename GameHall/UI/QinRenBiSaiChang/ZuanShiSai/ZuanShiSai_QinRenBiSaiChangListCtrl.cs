...
class ZuanShiSai_QinRenBiSaiChangListCtrl : ShowListUiDtCtrl
{
    /// <summary>
    /// 显示秦人比赛场(钻石赛)数据信息列表.
    /// </summary>
    public override void ShowListUiDt(Transform[] objTrAy)
    {
        ...
        object[] listDt = MainRoot._gUIModule.pUnModalUIControl.pBiSaiSelectUIView.pZuanShiSaiQinRenBiSaiChangDlg.QinRenBiSaiChangDt;
